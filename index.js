...
/////////////////
const BotName = 'B0T F1RM4N'; 
const instagram = 'https://instagram.com/r0l3.nime?igshid=1ixlr2n6sx0b8'; 
const telegram = 'nan'; 
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@r0l3.nime')
